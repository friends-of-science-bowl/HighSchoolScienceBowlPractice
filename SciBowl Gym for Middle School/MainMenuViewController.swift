...
class MainMenuViewController: UIViewController {
    ...
    @objc lazy var header: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "SciBowl Gym for Middle School"
    ...
    @objc lazy var quizModeButton: UIButton = {
    ...
    @objc lazy var readerModeButton: UIButton = {
        let button = UIButton(type: .system)
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setTitle("Moderator Mode", for: .normal)
        button.backgroundColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.25)
        button.tintColor = UIColor.white
        button.titleLabel?.font = UIFont.systemFont(ofSize: 18.0, weight: UIFont.Weight.light)
        button.clipsToBounds = true
    ...
    @objc lazy var studyModeButton: UIButton = {
        let button = UIButton(type: .system)
        button.translatesAutoresizingMaskIntoConstraints = false
    ...
    @objc lazy var aboutButton: UIButton = {
        let button = UIButton(type: .system)
        button.translatesAutoresizingMaskIntoConstraints = false
    ...
    @objc lazy var helpButton: UIButton = {
        let button = UIButton(type: .system)
        button.translatesAutoresizingMaskIntoConstraints = false
    ...
    @objc lazy var logoImage: UIImageView = {
