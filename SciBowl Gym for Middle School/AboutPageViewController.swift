...
class AboutPageViewController: UIViewController {
    ...
    @objc lazy var topHeader: UILabel = {
        let label = UILabel()
    ...
    @objc lazy var appPurposeLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.numberOfLines = 0
    ...
    @objc lazy var creatorLabel: UIView = {
        let label = RichTextView(
            font: UIFont.systemFont(ofSize: 15.0, weight: UIFont.Weight.medium),
            textColor: UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.8),
            frame: CGRect.zero
        )
        label.translatesAutoresizingMaskIntoConstraints = false
        label.update(input: "This app is released by Emily Liu, captain of The Harker School Science Bowl Team, and members of <a href='http://www.sciencebowlhub.org'>Science Bowl HUB</a>, a volunteer group to promote Science Bowl participation.  This app is based on an app released under the MIT license by <a href='https://github.com/jakepolatty/HighSchoolScienceBowlPractice-Android'>Jake Polatty</a>, co-captain of the Stanford University Online High School Science Bowl Team.")
        return label
    }()
    
    @objc lazy var accreditationLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.numberOfLines = 0
