...
extension UIButton {
    ...
    @objc func setBackgroundColor(color: UIColor, forState: UIControlState) {
...
class QuizSettingsViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    @objc let tossupTimePickerData = [["10 Seconds", "15 Seconds", "20 Seconds", "25 Seconds", "30 Seconds"]]
    @objc let bonusTimePickerData = [["10 Seconds", "15 Seconds", "20 Seconds", "25 Seconds", "30 Seconds", "35 Seconds", "40 Seconds"]]
    ...
    @objc lazy var generalScienceButton: UIButton = {
        ...
        button.clipsToBounds = true
        button.layer.cornerRadius = 10
        button.addTarget(self, action: #selector(QuizSettingsViewController.togglegeneralScience), for: .touchUpInside)
        return button
    }()
